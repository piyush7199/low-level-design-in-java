...
public class ScheduledState implements AuctionState {
    ...
    public void start(Auction auction) {
        ...
        System.out.println("Auction " + auction.getAuctionId() + " started");
    }

    @Override
    public void end(Auction auction) {
        System.out.println("Cannot end auction " + auction.getAuctionId() + " - not started yet");
    }
    ...
    public Bid placeBid(Auction auction, String userId, double amount) {
        throw new IllegalStateException("Cannot place bid - auction not started yet");
    }

    @Override
    public void printStatus(Auction auction) {
        System.out.println("Auction " + auction.getAuctionId() + " is SCHEDULED");
    }
}
